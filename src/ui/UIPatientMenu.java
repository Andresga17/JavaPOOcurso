        ...
        do {
            ...
            for (int i = 0; i < UIDoctorMenu.doctorsAvailableAppointmens.size(); i++) {
                ...
                for (int j = 0; j < availableAppointments.size(); j++) {
                    ...
                    doctorAppointments.put(Integer.valueOf(j), UIDoctorMenu.doctorsAvailableAppointmens.get(i));
            ...
            for (Map.Entry<Integer, Doctor> doc :doctorAvailableSelected.entrySet()) {
                indexDate = doc.getKey(); //Se obtiene la key del map
                doctorSelected = doc.getValue(); //Se obtiene el Objeto tipo Doctor
            }
